#ifndef MOVIEALBUMMODEL_H
#define MOVIEALBUMMODEL_H
...
class CAMERACORESHARED_EXPORT MovieAlbumModel : public QAbstractListModel
{
    Q_OBJECT
public:
    ...
    MovieAlbumModel(QObject* parent = nullptr);
